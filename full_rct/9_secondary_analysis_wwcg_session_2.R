...
# Make dummy models
m01_d <- lm(isq_total_s2~any_rm+prime+fsm+sen+mob+year+prop_wwcb_class+school, data=full_data_temp)
m02_d <-lm(isq_total_s2~any_rm+prime+fsm+sen+mob+year+prop_wwcb_class+any_rm*prop_wwcb_class+school, data=full_data_temp)
m03_d <- lm(isq_total_s2~any_rm+prime+fsm+sen+mob+year+prop_wwcb_class+prime*prop_wwcb_class+school, data=full_data_temp)
...
stargazer(m01_d, m02_d, m1_d, m2_d,  m4_d, m5_d,m10_d, m11_d,
          se = list(e_01, e_02, e_1, e_2,e_4, e_5, e_10, e_11),
...
# Make dummy models
m01_d <- lm(isq_total_s2~uni_rm+prime+uni_rm*prime+fsm+sen+mob+year+prop_wwcb_class+school, data=full_data_temp)
...
stargazer(m01_d,m1_d, m2_d, m4_d, 
          se = list(e_01,e_1, e_2,e_4),
          dep.var.labels.include = FALSE,
          star.cutoffs = c(0.1, 0.05, 0.01),
          star.char = c("+", "*", "**"), 
...
m01_d <- lm(isq_total_s2~t_uni+prime+fsm+sen+mob+year+prop_wwcb_class+school, data=full_data_temp)
m02_d <-lm(isq_total_s2~t_uni+prime+fsm+sen+mob+year+prop_wwcb_class+t_uni*prop_wwcb_class+school, data=full_data_temp)
m03_d <- lm(isq_total_s2~t_uni+prime+fsm+sen+mob+year+prop_wwcb_class+prime*prop_wwcb_class+school, data=full_data_temp)
...
# Make dummy models
m01_d <- lm(isq_total_s2~t_app+prime+fsm+sen+mob+year+prop_wwcb_class+school, data=full_data_temp)
m02_d <-lm(isq_total_s2~t_app+prime+fsm+sen+mob+year+prop_wwcb_class+t_app*prop_wwcb_class+school, data=full_data_temp)
m03_d <- lm(isq_total_s2~t_app+prime+fsm+sen+mob+year+prop_wwcb_class+prime*prop_wwcb_class+school, data=full_data_temp)
